...
int main(){
    ...
    const auto gained=euler_degrees(recentered_euler(quaternion_from_euler_degrees({55.0,30.0,25.0}),tilted_center,1.5));check(approx(gained[0],30)&&approx(gained[1],15)&&approx(gained[2],10),"view gain amplifies yaw and pitch but leaves roll unchanged");
